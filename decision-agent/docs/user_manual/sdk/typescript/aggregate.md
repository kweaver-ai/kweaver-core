<!-- 请勿直接编辑：本文件由 docs/user_manual/sdk/typescript 下的 `make aggregate` 生成。 -->
<!-- 来源文件：index.md, install-and-run.md, client-setup.md, agents.md, chat-streaming.md, conversations.md。 -->
