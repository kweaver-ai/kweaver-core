<!-- DO NOT EDIT: This file is generated by `make aggregate` in docs/user_manual/api. -->
<!-- Source files: index.md, agent-lifecycle.md, agent-config.md, agent-config-examples.md, publish-and-market.md, chat-and-conversation.md, incremental-streaming.md, debug-chat.md, conversation-session-run.md, import-export-and-auxiliary.md. -->
...
4. [对话](#对话-api) 与 [增量流式](#增量流式)：完成实际调用。
...
<!-- Source: agent-config-examples.md -->
...
<!-- Source: chat-and-conversation.md -->
...
<!-- Source: incremental-streaming.md -->
...
<!-- Source: conversation-session-run.md -->
...
<!-- Source: import-export-and-auxiliary.md -->
