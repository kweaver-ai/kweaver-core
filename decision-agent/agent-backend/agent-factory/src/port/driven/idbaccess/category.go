...
//go:generate mockgen -package idbaccessmock -destination ./idbaccessmock/category.go github.com/kweaver-ai/kweaver-core/decision-agent/agent-backend/agent-factory/src/port/driven/idbaccess ICategoryRepo
