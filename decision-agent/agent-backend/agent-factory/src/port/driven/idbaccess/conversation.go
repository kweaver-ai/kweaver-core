...
//go:generate mockgen -package idbaccessmock -destination ./idbaccessmock/conversation.go github.com/kweaver-ai/decision-agent/agent-factory/src/port/driven/idbaccess IConversationRepo
