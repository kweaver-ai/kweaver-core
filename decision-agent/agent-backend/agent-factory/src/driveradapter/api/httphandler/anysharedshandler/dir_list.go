...
import (
	...
	"github.com/kweaver-ai/kweaver-core/decision-agent/agent-backend/agent-factory/src/infra/cmp/httpproxy"
	"github.com/kweaver-ai/kweaver-core/decision-agent/agent-backend/agent-factory/src/infra/common/capierr"
	"github.com/kweaver-ai/kweaver-go-lib/rest"
)

func (h *anysharedsHandler) dirList(c *gin.Context) {
	...
	targetURL := fmt.Sprintf("%s://%s:%d/api/efast/v1/dir/list", reqParam.Protocol, reqParam.Host, reqParam.Port)
