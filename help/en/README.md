...
- [Deploy](installation/deploy.md) — one-click install with `deploy.sh`
- [Verify installation](installation/verify.md) — cluster health and API checks
...
- [Demo cover](../demo-cover.png) — used by the root README
- [Community QR](../qrcode.png)
