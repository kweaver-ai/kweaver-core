...
4. **[`help/{en,zh}/cookbook/`](../help/zh/cookbook)** — **Cookbook**：可复制的场景化操作步骤；新篇目与索引并排维护，结构遵循 [`cookbook/README.md`](../help/zh/cookbook/README.md) 中的模版说明，可参考示例 [`cookbook_example.md`](../help/zh/cookbook/cookbook_example.md)（英文在 `help/en/cookbook/`）。
