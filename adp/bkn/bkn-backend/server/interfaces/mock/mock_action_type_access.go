...
//
//	mockgen -source ../interfaces/action_type_access.go -destination ../interfaces/mock/mock_action_type_access.go
//
...
func (m *MockActionTypeAccess) DeleteActionTypesByKnID(ctx context.Context, tx *sql.Tx, knID, branch string) (int64, error) {
	m.ctrl.T.Helper()
