...
//
//	mockgen -source ../interfaces/job_executor.go -destination ../interfaces/mock/mock_job_executor.go
//
...
func (m *MockJobExecutor) AddJob(ctx context.Context, jobInfo *interfaces.JobInfo) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddJob", ctx, jobInfo)
	ret0, _ := ret[0].(error)
	return ret0
}
