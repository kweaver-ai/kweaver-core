...
//
//	mockgen -source ../interfaces/opensearch_access.go -destination ../interfaces/mock/mock_opensearch_access.go
//
...
func (m *MockOpenSearchAccess) GetIndexStats(ctx context.Context, indexName string) (*interfaces.IndexStats, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIndexStats", ctx, indexName)
	ret0, _ := ret[0].(*interfaces.IndexStats)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockOpenSearchAccess) Refresh(ctx context.Context, indexName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Refresh", ctx, indexName)
	ret0, _ := ret[0].(error)
	return ret0
}
