...
//
//	mockgen -source ../condition/condition.go -destination ../condition/mock/mock_condition.go
//
...
func (mr *MockConditionMockRecorder) Convert(ctx, vectorizer any) *gomock.Call {
...
func (mr *MockConditionMockRecorder) Convert2SQL(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
