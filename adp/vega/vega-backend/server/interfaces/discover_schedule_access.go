...
// DiscoverScheduleAccess defines data access interface for scheduled discover tasks.
//
...
type DiscoverScheduleAccess interface {
	...
	Create(ctx context.Context, task *DiscoverSchedule) error
	...
	Update(ctx context.Context, task *DiscoverSchedule) error
